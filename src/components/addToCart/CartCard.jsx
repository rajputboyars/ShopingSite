    ...
    <>
        <div className="flex flex-row w-[1000px] h-[100px] align-middle bg-zinc-100 p-[10px] my-2 justify-between text-left m-auto">
            <div className='w-[100px]'>
                <img className="h-[80px] w-full" src={thumbnail} alt="image" />
            </div>
            <div className='flex flex-row justify-between w-[700px] self-center'>
                <div className=" h-fit w-[170px] align-middle items-center">
                    {title}
                </div>
                <div className=" h-fit w-[350px] align-middle truncate px-5">
                    {description}
                </div>
                <div className=" h-fit w-[100px] align-middle">
